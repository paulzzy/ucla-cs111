...
void write_superblock(int fd) {
  ...
  superblock.s_checkinterval =
      0;                       /* Force checks by making them every 1 second */
...
void write_block_bitmap(int fd) { /* This is all you */ }

void write_inode_bitmap(int fd) { /* This is all you */ }
...
void write_root_dir_block(int fd) { /* This is all you */ }
...
void write_hello_world_file_block(int fd) { /* This is all you */ }
